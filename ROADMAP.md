...
- [ ] Adopt the shared `zkm.pdftext` helper + run the density-ratio pilot (replaces the local min-text "scanned-only" heuristic) [HARD — decision gate] — 🚧 GATED (auto, id:3801; route:hard-split): DECOMPOSED into seams id:cd59, id:8aa4 — pick those, not this. Adoption half (id:cd59) SHIPPED 2026-06-24 (a60c76b). Pilot half (id:8aa4) remains data-gated: no zkm-pdf-skipped.jsonl corpus exists yet. <!-- id:9475 -->
